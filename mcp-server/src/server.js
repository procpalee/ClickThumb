...
export function createServer() {
  ...
  server.registerTool('smart_thumbnail', {
    ...
    inputSchema: {
      ...
      handle: z.string().optional().describe('블로그 핸들/워터마크 텍스트 (예: @procpa). 로고가 있으면 로고만 표시되고 이 텍스트는 생략됨'),
      logoPath: z.string().optional().describe('워터마크 로고 이미지 로컬 경로 (하단 중앙, 로고 단독 표시). 미지정 시 set_defaults의 기본 로고 사용'),
